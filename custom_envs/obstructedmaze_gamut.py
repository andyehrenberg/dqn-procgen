...
register(id="MiniGrid-ObstructedMazeGamut-Easy-v0", entry_point=f"{__name__}:ObstructedMazeGamut_Easy")

register(id="MiniGrid-ObstructedMazeGamut-Medium-v0", entry_point=f"{__name__}:ObstructedMazeGamut_Medium")

register(id="MiniGrid-ObstructedMazeGamut-Hard-v0", entry_point=f"{__name__}:ObstructedMazeGamut_Hard")
