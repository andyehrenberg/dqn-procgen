        ...
        for actor_index in range(num_actors):
            ...
            for t in done_steps:
                ...
                if self.requires_value_buffers:
                    score_function_kwargs["returns"] = rollouts.transitions.data["return"][
                        start_t:t, actor_index
                    ]
                    score_function_kwargs["rewards"] = rollouts.transitions.data["reward"][
                        start_t:t, actor_index
                    ]
                    score_function_kwargs["value_preds"] = rollouts.transitions.data["value_pred"][
                        start_t:t, actor_index
                    ]
